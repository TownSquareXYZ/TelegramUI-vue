<template>
  <div v-bind="$props" :style="{
    ...
    <img v-if="hasSrc" :alt="alt" :class="styles.image" :crossorigin="crossorigin" :decoding="decoding"
      :loading="loading" :referrerpolicy="referrerpolicy" :sizes="sizes" :src="src" :srcset="srcset" :usemap="usemap"
